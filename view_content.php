...
<p id="nav-breadcrumbs2"><a href="view_cat.php?type=mobile">Mobile phones</a> \ <span>'.$row1["brand"].'</span></p>
<div id="block-like">
<p id="likegood" tid="'.$id.'" >Like</p><p id="likegoodcount" >'.$row1["yes_like"].'</p>
</div>
</div>
...
<div>
<p id="link-send-review" ><a class="send-review" href="#send-review" >Write a review</a></p>
';
...
{
    echo '<p class="title-no-info" >No reviews</p>';
} 
...
echo '
    ...
    <p align="right" id="title-review">Publication of reviews performed after preliminary moderation.</p>
    
    <ul>
    <li><p align="right"><label id="label-name">Name<span>*</span></label><input maxlength="15" type="text"  id="name_review" /></p></li>
    <li><p align="right"><label id="label-good">Dignity<span>*</span></label><textarea id="good_review" ></textarea></p></li>    
    <li><p align="right"><label id="label-bad">Shortcomings<span>*</span></label><textarea id="bad_review" ></textarea></p></li>     
    <li><p align="right"><label id="label-comment">Comments</label><textarea id="comment_review" ></textarea></p></li>     
    </ul>
