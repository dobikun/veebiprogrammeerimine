...
<p id="nav-breadcrumbs"><a href="index.php" >Home page</a> \ <span>All products</span></p>
<ul id="options-list">
<li>View: </li>
...
<ul id="sorting-list">
<li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=price-asc" >From cheap to expensive</a></li>
<li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=price-desc" >From expensive to cheap</a></li>
<li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=popular" >Popular</a></li>
<li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=news" >New</a></li>
<li><a href="view_cat.php?'.$catlink.'type='.$type.'&sort=brand" >From to Z</a></li>
</ul>
</li>
</ul>
</div>
...
{
    echo '<h3>Category is not available or does not exist!</3>';
}    
