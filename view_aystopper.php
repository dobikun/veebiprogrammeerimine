...
<p id="nav-breadcrumbs"><a href="index.php" >Home</a> \ <span>All Products<span><?php echo $name_aystopper; ?></span></p>
<ul id="options-list">
<li>View: </li>
...
<ul id="sorting-list">
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-asc" >From cheap to expensive</a></li>
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-desc" >From expensive to cheap</a></li>
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=popular" >Popular</a></li>
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=news" >New</a></li>
<li><a href="view_aystopper.php?go=<?php echo $go; ?>&sort=brand" >From A to Z</a></li>
</ul>
</li>
</ul>
</div>
...
}else
{
    ...
    {
        echo '<p>This category was not found!</p>';
    }
