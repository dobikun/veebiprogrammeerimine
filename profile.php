...
{	
   ...
   if ($_POST["save_submit"])
      ...
      if($_POST["info_new_pass"] != "")
	{
            	...
            	{
		           $error[]='Enter the new password from 7 to 15 characters!';
	            }else
                {
	...
	{
		$error[]='Specify the name of 3 to 15 characters!';
	}
	...
	{
		$error[]='Specify the Middle of 3 to 25 characters!';
	}  
	...
	{
		$error[]='Specify the address of delivery!';
	}      
...
<h3 class="title-h3" >Change profile</h3>
...
<li>
<label for="info_patronymic">Patronymic</label>
<span class="star">*</span>
...
<li>
<label for="info_phone">Telephone</label>
<span class="star">*</span>
<input type="text" name="info_phone" id="info_phone" value="<?php echo $_SESSION['auth_phone']; ?>" />
</li>

<li>
<label for="info_address">Delivery Address</label>
<span class="star">*</span>
<textarea name="info_address"  > <?php echo $_SESSION['auth_address']; ?> </textarea>
 ...
 <p align="right"><input type="submit" id="form_submit" name="save_submit" value="Save" /></p>
</form>
