...
<p id="nav-breadcrumbs"><a href="index.php" >Home page</a> \ <span>Search</span></p>
<ul id="options-list">
<li>View: </li>
...
<li><a href="index.php?sort=brand" >From A to Z</a></li>
</ul>
</li>
</ul>
</div>
...
}else
{
  ...
  {
     echo "<p>Search value should be from 3 to 150 characters!</p>";
  }
?>
